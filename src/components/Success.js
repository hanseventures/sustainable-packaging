    ...
    <section className="l-success container bg-secondary">
      ...
      <div className="content content--roomy d-grid">
        ...
        <div className="d-flex row-gap-3 column-gap-3 trimmed-3 mt-5 text-xs-center">
          ...
          <svg viewBox="0 0 79 79" height="79" width="79" xmlns="http://www.w3.org/2000/svg">,,<g transform="matrix(3.2916666666666665,0,0,3.2916666666666665,0,0)"><path d="M18.825,12.374l1.251,2.252h2.481a.68.68,0,0,1,.489,1.163l-2.278,2.486,1.262,2.9a.688.688,0,0,1-.979.86L18,20.318l-3.05,1.716a.688.688,0,0,1-.98-.86l1.22-2.8" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M5.175,12.374,3.924,14.626H1.443a.68.68,0,0,0-.489,1.163l2.278,2.486-1.262,2.9a.688.688,0,0,0,.979.86L6,20.318l3.05,1.716a.688.688,0,0,0,.98-.86l-1.22-2.8" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M12.368,2.141l1.989,3.977,3.827.383a.485.485,0,0,1,.294.825l-3.152,3.152,1.168,4.283a.484.484,0,0,1-.684.56l-3.875-1.937L8.06,15.321a.484.484,0,0,1-.683-.56l1.168-4.283L5.393,7.326A.485.485,0,0,1,5.687,6.5l3.826-.383L11.5,2.141A.484.484,0,0,1,12.368,2.141Z" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>
          ...
          <article className="card card--default d-flex flex-basis-full flex-align-center flex-column py-5 px-3">
            ...
            <svg viewBox="0 0 79 79" height="79" width="79" xmlns="http://www.w3.org/2000/svg">,<g transform="matrix(3.2916666666666665,0,0,3.2916666666666665,0,0)"><path d="M12.593,6.8l1.4,2.95h2.377a.651.651,0,0,1,.469,1.114L14.652,12.81l1.209,2.778a.658.658,0,0,1-.938.823L12,14.767,9.077,16.411a.658.658,0,0,1-.938-.823L9.348,12.81,7.165,10.864A.651.651,0,0,1,7.634,9.75h2.377l1.4-2.95A.665.665,0,0,1,12.593,6.8Z" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path><path d="M0.750 12.000 A11.250 11.250 0 1 0 23.250 12.000 A11.250 11.250 0 1 0 0.750 12.000 Z" fill="none" stroke="#000" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5"></path></g></svg>
