...
const TextWithImage = props => {
  return (
    <section className="text-image text-image--left container bg-wht">

      <div className="content content-centered content-roomy trimmed-width-3 d-grid column-gap-4 row-gap-3">
