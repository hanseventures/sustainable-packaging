    ...
    <section id="kundenstimmen" className="l-testimonials container">
      ...
      <div className="content content-default d-grid">
        ...
        <div className="wrapper text-xs-center">
          ...
          <h3 className="h-2">Das sagen unsere Kunden</h3>
          ...
          <div className="mb-4 d-flex">
            ...
            <article className="d-flex flex-align-center flex-column">
              ...
              <blockquote className="mx-3 font-sm">
                <i>"Die LVZ wird aufmerksam gelesen. Dies gilt somit auch für die Inhalte von DAVID VAN L., die wir hier platzieren."</i>
              </blockquote>
              ...
              <div className="mb-4 mt-2">
                <small className="font-xs">
                  ...
                  <br></br>
                  Geschäftsführer <br></br> Herrenausstatter in Leipzig
                </small>
              </div>

              <img src="/images/lvz/lvz-testimonial-logo-david_van_l.jpg" alt="tunici restaurant logo" className="mb-4"></img>
